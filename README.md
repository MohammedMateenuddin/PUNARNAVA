...
### *AI-Powered E-Waste Intelligence Platform*
...
[🚀 Live Demo](#-quick-start) · [📖 Features](#-features) · [🏗️ Architecture](#️-architecture) · [⚡ Setup](#-quick-start)
...
### 👤 User Dashboard
- **Eco Impact Tracker** — CO₂ saved, devices recycled, total recovery value
...
│                    PUNARNAVA PLATFORM                     │
├──────────────────────┬──────────────────────────────────┤
│     USER APP         │        RECYCLER APP              │
│  ┌───────────────┐   │   ┌──────────────────┐          │
│  │  AI Scanner   │   │   │  Scrap Market    │          │
│  │  Dashboard    │   │   │  Device Intake   │          │
...
│                   SHARED SERVICES                        │
│  ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌────────────┐ │
│  │ Firebase │ │ Gemini   │ │ Metal    │ │ YouTube    │ │
│  │ Auth+DB  │ │ Vision   │ │ Prices   │ │ API        │ │
│  └──────────┘ └──────────┘ └──────────┘ └────────────┘ │
└─────────────────────────────────────────────────────────┘
```
...
| **AI Vision** | Google Gemini 1.5 Flash | Real-time device identification & material analysis |
| **Auth** | Firebase Authentication | Google OAuth + Email/Password |
| **Database** | Cloud Firestore | Real-time sync, leaderboards, user profiles |
| **Charts** | Recharts | Analytics dashboards & material breakdowns |
| **Camera** | MediaDevices API | Cross-device camera with multi-constraint fallback |
| **Drag & Drop** | react-dropzone | Image upload with drag-and-drop support |
...
| Metric | Description |
|--------|-------------|
| **CO₂ Tracking** | Calculates carbon savings per recycled device |
